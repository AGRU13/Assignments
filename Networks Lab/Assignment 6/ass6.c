...
int is_download(char *ctype){
    return ctype!=NULL && (strstr(ctype,"image/jpeg")||strstr(ctype,"image/svg+xml")||strstr(ctype,"application/pdf")||strstr(ctype,"image/png"));
}
            ...
            if(m->msg == CURLMSG_DONE) {
                ...
                if(m->data.result == CURLE_OK) {
                    ...
                    if(res_status == 200) {
                        ...
                        }else if(is_html(ctype) && mem->size > 100) {
