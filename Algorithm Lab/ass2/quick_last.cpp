...
/* This function takes last element or middle element as pivot, places the pivot element at its correct position in sorted array,
 and places all smaller (smaller than pivot) to left of pivot and all greater elements to right of pivot */
long int partition(int arr[],int low,int high)  
{  
    	/* Unmute the Desired Pivot */
    	int pivot=arr[high];		//For Average and Worst case
    	//long int pivot=arr[(low+high)/2];  	// For Best Case
